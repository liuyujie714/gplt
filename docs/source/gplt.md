...
```
<img src="./_static/rdf.png"  alt="rdf" width="400"/>
<img src="./_static/rdf2.png" alt="rdf" width="400"/>
...
gplt -f ss.xpm
```
<img src="./_static/gibbs.png"  alt="rdf" width="400"/>
<img src="./_static/ss.png"     alt="rdf" width="400"/>
...
<img src="./_static/densmap.png"     alt="rdf" width="400"/>

### dssp.dat for gmx dssp [gmx >= 2023]
```bash
gplt -f dssp.dat && gplt -f dssp.xpm && gplt -f scount.xvg
```
<img src="./_static/dssp.png"     alt="rdf" width="400"/>
<img src="./_static/scount.png"     alt="rdf" width="400"/>
